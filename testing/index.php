...
<head>
    ...
    <title>Hero Section - Testing</title>
...
<?php 
    ...
    <header class="ezy__header42_LIvGiG1q">
        <!-- shape one -->
        <svg
        ...
        >
                         <path d="M0 62V0H62C62.0281 34.238 34.2662 62 0 62Z" fill="#d10000" fill-opacity="0.26" />
        </svg>

        <!-- shape two -->
        <svg
            class="ezy__header42_LIvGiG1q-shape-two"
            width="49"
            height="40"
            viewBox="0 0 49 40"
            fill="none"
        ...
        <!-- shape four -->
        <svg
            class="ezy__header42_LIvGiG1q-shape-four"
            width="90"
            height="81"
            viewBox="0 0 90 81"
            fill="none"
        ...
        <!-- shape six -->
        <svg
            class="ezy__header42_LIvGiG1q-shape-six"
            width="149"
            height="255"
            viewBox="0 0 149 255"
            fill="none"
        ...
        <!-- bg shape -->
        <div class="ezy__header42_LIvGiG1q-bg-shape"></div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-5 position-relative text-center">
                    <!-- shape seven -->
                    <svg
                        class="ezy__header42_LIvGiG1q-shape-seven position-absolute top-0"
                        width="291"
                        height="168"
                        viewBox="0 0 291 168"
                        fill="none"
